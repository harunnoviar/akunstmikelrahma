            ...
            <div class="card card-light shadow shadow-lg">
               <div class="card-header">
                  <div class="row">
                     <div class="col-lg-6">
                        <h2><?= $c_name ?></h2>
                        <input type="text" name="c_id" id="c_id" hidden value="<?= enkrip($c_id) ?>">
                     </div>
                     <div class="col-lg-6 text-right">
                        <a href="<?= base_url('admin/category') ?>" class="btn btn-sm btn-info"> <i class="fas fa-angle-left"></i> Kembali</a>
...
<script>
   ...
   $(document).ready(function() {
      ...
      table = $('#table_user').DataTable({
         ...
         'serverMethod': 'post',
         'ajax': {
            'url': '<?= base_url() ?>/admin/ctgdetfetch/' + c_id
         },
         order: [
            [0, 'desc']
         ],
