...
class Auth
{
    ...
    public bool $allowFacebook = false;
    public bool $allowGmail = true;
    public bool $allowSso = true;
    ...
    public function loginRedirect(): string
    {
        ...
        //     $url = $this->pathModule['superadmin'];
        //     session()->set(['superadmin_stat' => true]);
        // } elseif (auth()->user()->inGroup('admin')) {
        //     $url = $this->pathModule['admin'];
        //     session()->set(['admin_stat' => true]);
        // } elseif (auth()->user()->inGroup('user')) {
        //     $url = $this->pathModule['user'];
        //     session()->set(['user_stat' => true]);
        // } else {
        //     $url = setting('Auth.redirects')['login'];
        // }
        // return $this->getUrl($url);
        return $this->getUrl('hhh');
    }
